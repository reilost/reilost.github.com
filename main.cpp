...
//  Test
//
//  Created by Reilost on 6/7/13.
//  Copyright (c) 2013 Reilost. All rights reserved.
//
...
int main()
{
    void(*aBlock)(void) = (void (*)(void))&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA);
    ((void (*)(struct __block_impl *))((struct __block_impl *)aBlock)->FuncPtr)((struct __block_impl *)aBlock);
    return 0;
}
